...
function exportData(){downloadText(`personal-healthcare-v9.1-backup-${new Date().toISOString().slice(0,10)}.json`,JSON.stringify({version:"9.1",exported_at:new Date().toISOString(),...db},null,2),"application/json")}
