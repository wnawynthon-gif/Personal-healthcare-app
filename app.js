...
function renderDoctor(){
 ...
 <p class="muted">Generated by Personal Healthcare v6.5 from user-entered data. This summary is not a diagnosis and does not replace the original laboratory report or clinician medication list.</p>`;
}
...
async function v622ProcessFiles(files){
 ...
 try{
   ...
   setOcrProgress('อ่านเอกสารเสร็จแล้ว — V6.5 Smart Lab Importer: ไม่เลือกผล OCR อัตโนมัติ กรุณาติ๊กเฉพาะค่าที่ตรงกับใบจริง',100);v622RenderDocumentMeta();renderDetectedRows();
